...
b = pre_builts.simple_linear(num_cells, t_high, t_low, t_init, t_eq,
                             cell_x_len, cell_y_len)
...
json_filepath = f'json/{filename}'
results_filepath = f'json/results/ss_{filename[:-4]}txt'
...
pp.plot_linear([axis1, axis2], [results_filepath, results_filepath],
               main_title='main_title', temp_title='temp title here',
               x_flux_title='x_flux_title_here',
               y_flux_title='y_flux_title_here', legend_labels=labels,
               normalize_axis=True, outfile='linear_demo')
