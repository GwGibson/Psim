...
function(psim_enable_doxygen DOXYGEN_THEME)
  ...
  if(NOT DOXYGEN_EXCLUDE_PATTERNS)
    set(DOXYGEN_EXCLUDE_PATTERNS "${PROJECT_SOURCE_DIR}/out/*" "${PROJECT_SOURCE_DIR}/build/*"
                                 "${PROJECT_SOURCE_DIR}/psim_python/*" "${PROJECT_SOURCE_DIR}/psim/include/psim/json.h")
  endif()
