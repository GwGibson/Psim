...
macro(psim_setup_options)
  ...
  if(ENABLE_DEVELOPER_MODE)
    ...
    option(psim_ENABLE_COVERAGE "Enable coverage reporting" ON)
    ...
    option(psim_ENABLE_COVERAGE "Enable coverage reporting" OFF)
...
macro(psim_local_options)
  ...
  if(psim_ENABLE_COVERAGE)
    include(cmake/Tests.cmake)
    psim_enable_coverage(psim_options)
  endif()
